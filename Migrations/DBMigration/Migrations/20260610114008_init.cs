...
namespace DBMigration.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateSequence(
                name: "DeferredPaymentSequence");

            migrationBuilder.CreateSequence(
                name: "DeferredPaymentTransactionSequence");

            migrationBuilder.CreateSequence(
                name: "InventoryTransactionSequence");

            migrationBuilder.CreateSequence(
                name: "ProductDetailsSequence");

            migrationBuilder.CreateSequence(
                name: "ProductSequence");

            migrationBuilder.CreateSequence(
                name: "ReturnInvoiceItemSequence");

            migrationBuilder.CreateSequence(
                name: "ReturnInvoiceSequence");

            migrationBuilder.CreateSequence(
                name: "ReturnReasonSequence");

            migrationBuilder.CreateSequence(
                name: "SalesInvoiceItemSequence");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeferredPayment = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedBy = table.Column<long>(type: "bigint", nullable: false),
                    UpdatedBy = table.Column<long>(type: "bigint", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeferredPayment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeferredPayment_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeferredPayment_SalesInvoice_SalesInvoiceId",
            ...
            migrationBuilder.CreateTable(
                name: "DeferredPaymentTransaction",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                    DeferredPaymentId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeferredPaymentTransaction", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeferredPaymentTransaction_DeferredPayment_DeferredPaymentId",
                        column: x => x.DeferredPaymentId,
                        principalTable: "DeferredPayment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeferredPayment_CustomerId",
                table: "DeferredPayment",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_DeferredPayment_SalesInvoiceId",
                table: "DeferredPayment",
                column: "SalesInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_DeferredPaymentTransaction_DeferredPaymentId",
                table: "DeferredPaymentTransaction",
                column: "DeferredPaymentId");
