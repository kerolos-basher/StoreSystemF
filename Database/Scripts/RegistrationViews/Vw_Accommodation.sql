/*
    Accommodation Excel view — Domain Vw_Accommodation + accommodationComment
...
IF OBJECT_ID(N'[dbo].[Vw_Accommodation]', N'V') IS NOT NULL
    DROP VIEW [dbo].[Vw_Accommodation];
GO

CREATE VIEW [dbo].[Vw_Accommodation]
AS
SELECT *
...
                                        , RF.NumberOfTickets
                                        ,RF.Comment
										,RF.IsDeleted as IsFlightDeleted
										, CASE
...
                                             ,R.EnglishDescription As RoomType
                                            ,RA.Comment as AccommodationComment
